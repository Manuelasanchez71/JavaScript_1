let data = {
  ...
  data.movies.map(movie => {
    ...
    console.log(`Box Office: ${movie.box_office}`);
    console.log('Awards:');
    movie.awards.forEach(award => console.log(`  - ${award}`));
    console.log('Cast:');
    movie.cast.forEach(member => console.log(`  Name: ${member.name}, Role: ${member.role}`));
    console.log('Reviews:');
    movie.reviews.forEach(review => {
      console.log(`  Critic: ${review.critic}`);
      console.log(`  Publication: ${review.publication}`);
  ...
  data.movies.map(movie => {
    ...
    console.log(`Box Office: ${movie.box_office}`);
    console.log('Awards:');
    movie.awards.map(award => console.log(`  - ${award}`));
    console.log('Cast:');
    movie.cast.map(member => console.log(`  Name: ${member.name}, Role: ${member.role}`));
    console.log('Reviews:');
